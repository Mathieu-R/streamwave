      ...
      <div class="register">
        <form class="register-form" onSubmit={this.register}>
          <div class="register-form__email input-wrapper">
            ...
            <input ref={input => this.email = input} type="email" id="email" class="register-form__email__input"/>
          </div>
          <div class="register-form__password input-wrapper">
            ...
            <input ref={input => this.password = input} type="password" id="password" class="register-form__password__input"/>
          </div>
          <div class="register-form__password-confirm input-wrapper">
            ...
            <input ref={input => this.passwordConfirm = input} type="password" id="password-confirm" class="register-form__password-confirm__input"/>
          </div>
