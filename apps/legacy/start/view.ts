...
const dateFormatter = i18nManager.locale('en')
...
// route helper
// similar to AdonisJS Edge route helper
// https://github.com/adonisjs/core/blob/develop/providers/edge_provider.ts
...
// create <img> element with proper src path
...
// create <script> or <link> elements for entrypoint
